/*! ONNX Runtime Web v1.29.0 — WASM-only self-contained ESM bundle.
 * Source: node_modules/onnxruntime-web/dist/ort.wasm.bundle.min.mjs
 * Loads src/vendor/ort-wasm-simd-threaded.{mjs,wasm} (~13MB), not the 27MB jsep all-backends binary.
 * WebGPU is a bonus path only; WASM is the extension baseline.
 */
/*!
