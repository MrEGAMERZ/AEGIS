...
## Corpus Check
- 81 files · ~96,284 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1251 nodes · 1586 edges · 98 communities (87 shown, 11 thin omitted)
...
9. `🎯 Aegis — Deep Structured Analysis` - 13 edges
10. `Lead Work Report` - 13 edges
...
### Community 5 - "00_INDEX.md"
Cohesion: 0.05
Nodes (39): Aegis — On-device Visual Perception for Light-weight Browser Agents, Evaluation Criteria (5 Explicitly Weighted), Key Technical Decisions (Summary), Planning Documents, Project Overview, Research Documents (from analysis phase), 02 — Architecture, 1. System Overview (+31 more)
...
Cohesion: 0.11
Nodes (16): 2026-08-28 — INIT_FAILED: `chrome is not defined` in dedicated module Worker, 2026-08-28 — INIT timeout in Chrome for Testing (BlazeFace load path), 2026-08-28 — Live NER (PER/ORG/LOC) actually runs; fail-closed before VLM, 2026-08-28 — Live-path DETECT_FACES contract + fail-closed (Lead / ML), 2026-08-28 — Module-Worker load bug CONFIRMED + fixed; two more real bugs found along the way; NER model ID fixed, 2026-08-28 — ORT WASM dynamic-import of `.mjs` in the module worker, Environment for these numbers, Fixes applied (inference.worker.js) (+8 more)
...
Cohesion: 0.18
Nodes (12): applyBoxRect(), attributeTokens(), buildSelector(), ensureOverlayListeners(), executeClick(), getOrCreateOverlayRoot(), makeOverlayBox(), repositionOverlays() (+4 more)
...
Cohesion: 0.11
Nodes (17): 2026-08-28 — Acceptance: live face redaction before VLM, 2026-08-28 — Acceptance: live NER redaction of names/places/orgs before VLM, 2026-08-28 — Content-script inject after extension reload (file://), 2026-08-28 — INIT_FAILED worker load (chrome is not defined) — harness + Chrome probe, 2026-08-28 — INIT timeout (Chrome for Testing, before VLM), 2026-08-28 — ORT WASM `.mjs` dynamic-import miss (harness), 2026-08-28 — Re-verification of Task 2.5 gate (profile-injection fix), 2026-08-28 — Six-item demo pack (auth, fail-closed, dynamic DOM, URL strip, popup, Chrome E2E) (+9 more)

### Community 41 - "Privacy Work Report"
Cohesion: 0.13
Nodes (14): 2026-08-28 — Content-script re-inject after Reload (privacy clearance), 2026-08-28 — Finding B re-opened then closed: live faces could still reach the VLM, 2026-08-28 — Finding C re-opened then closed: live NER dropped every PER/ORG/LOC, 2026-08-28 — Finding D closed in the VLM payload; F-11 key path implemented, 2026-08-28 — ORT WASM init miss stays fail-closed (privacy clearance), 2026-08-28 — Sticky overlays + wasmBinary prefetch (privacy clearance), Lead note (2026-08-28) — Findings B, C, E were accurate at read-time, now resolved; F partially resolved, Methodology / caveat (+6 more)
...
Cohesion: 0.18
Nodes (10): 2026-08-28 — Classify ORT WASM backend miss (not [UNKNOWN]), 2026-08-28 — Fix: missing-data hallucination in smart form-fill (RAG), 2026-08-28 — INIT timeout: offscreen worker ready-path, 2026-08-28 — Live face redaction is a hard gate before any VLM call, 2026-08-28 — Live NER (PER/ORG/LOC) is a hard gate before any VLM call, 2026-08-28 — Post-reload "Receiving end does not exist" on file:// tabs, 2026-08-28 — Session API key, omit URL/title from VLM, fail-closed audit, 2026-08-28 — Worker onerror copy after chrome-API INIT crash (+2 more)
...
## Knowledge Gaps
- **707 isolated node(s):** `fs`, `path`, `vm`, `ROOT`, `BACKGROUND_PATH` (+702 more)
